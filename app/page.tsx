...
export default async function Home() {
  ...
  return (
    <div className="flex flex-wrap">
      ...
      <Link  key={index} href={'/list/'+item.list_name_encoded}> 
        <div className="flex-full bg-white dark:bg-slate-800 rounded-lg px-5 py-5  m-3 ring-1 ring-slate-900/5 shadow-xl">
